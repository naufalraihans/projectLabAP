...
import { ArrowLeft, Download, Terminal, Code, Youtube } from "lucide-react";
...
export default function AplikasiPage() {
  const apps = [
    ...
    {
      name: "Video Tutorial",
      desc: "Kumpulan video tutorial praktikum.",
      href: "https://drive.google.com/drive/folders/17RzF3P5NPEq7aMzIu-cHz2RcxP2HkBvp?usp=drive_link",
      icon: <Youtube size={32} className="text-red-500" />,
      actionText: "Tonton Sekarang",
      actionIcon: <Youtube size={16} className="mr-2" />,
    },
  ];
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center text-purple-400 font-medium text-sm group-hover:underline decoration-purple-400/30 underline-offset-4">
                  {app.actionIcon || <Download size={16} className="mr-2" />}
                  {app.actionText || "Download Sekarang"}
                </div>
              </div>
            </a>
          ))}
